...
enum Command {
    ...
    /// Generate a Manifest.txt file accurately.
    ///
    /// Unlike vanilla script compilation, the Manifest.txt generated by this command will look
    /// through *compiled* packages, which means it'll also include classes from mods if you
...
fn main() {
    ...
    info!("Stitchkit version {}", env!("CARGO_PKG_VERSION"));
